...
{\centering \includegraphics[width=0.7\linewidth]{Alexander-van-der-Voorn_dissertation_files/figure-latex/unnamed-chunk-16-1} 

}

\caption{The baseline and descender of the letter y}\label{fig:unnamed-chunk-16}
\end{figure}
