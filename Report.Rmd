...
Explain DVI more here (and less in)
...
TikZ is a \TeX package that allows drawing of pictures in \TeX documents:

- [**Example:** simple TikZ drawing (circles with labels, and an arrow maybe)]

- [**Example:** more complicated TikZ drawing]

The original DVI file specification

`dvir` already had functionality to include TikZ drawings in R [reference Paul dvir TikZ report].
