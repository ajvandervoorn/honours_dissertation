...
To tackle step 1, we need to update the `dvir` TikZ driver file to include information about the gradient and pagtern fills. As the `dvir` TikZ driver file is based on the SVG TikZ driver file, the SVG support for TikZ fills was used as a base to edit to make it specific to `dvir`.
