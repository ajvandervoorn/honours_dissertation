...
R has the ability to display mathematical symbols and equations in graphics using the "*plotmath*" feature, interpretting everything within a call to `expression()` as a mathematical equation.
