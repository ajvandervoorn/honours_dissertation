...
```{r speedUp2Simple, fig.cap = "The average time spent in the \\texttt{grid.latex()} function and font sweep for each of the 20 runs of the simple example.", echo = FALSE, fig.width = 5, fig.height = 4}
...
```{r speedUp2Yee, fig.cap = "The average time spent in the \\texttt{grid.latex()} function and font sweep for each of the 20 runs of the complicated example", echo = FALSE, fig.width = 5, fig.height = 4}
