...
grid.latex("$Y_{\\pi} | Y_{\\pi} \\notin \\cal{A}$", x = xpos[4], y = -0.1, default.units="native")
...
```{r yeeExample, fig.cap="Using nine `grid.latex()` calls to create a graphic.", fig.wdith = 2.5, fig.height = 4, fig.keep = "last", echo = FALSE}
xpos <- c(0, 0.25,  0.7, 1)
...
The example in figure \ref{yeeExample} was created by a University of Auckland lecturer using the `dvir` package to help write an assignment.
