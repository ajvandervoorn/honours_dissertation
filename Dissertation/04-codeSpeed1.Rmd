...
--->
```{r prof1, fig.cap = 'Screenshot of \\texttt{profvis::profvis()} output for the code \\texttt{grid.latex("$x - \\mu$")} in \texttt{dvir} version 0.2-1.', echo = FALSE, eval = TRUE, out.width='100%'}
...
```{r prof3, fig.cap = 'Screenshot of \\texttt{profvis::profvis()} output for the code \\texttt{grid.latex("$x - \\mu$")} in \\texttt{dvir} version 0.2-1, highlighting \\texttt{engine\\$fontDef}.', echo = FALSE, eval = TRUE, out.width='100%'}
