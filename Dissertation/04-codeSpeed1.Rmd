...
```{r yeeExample, fig.cap="Using nine \\texttt{grid.latex()} calls with base R graphics.", fig.wdith = 2.5, fig.height = 4, fig.keep = "last", echo = FALSE}
xpos <- c(0, 0.25,  0.7, 1)
...
--->
```{r prof1, fig.cap = "Screenshot of 'profvis::profvis()' output for the simple example in 'dvir' version 0.2-1.", echo = FALSE, eval = TRUE, out.width='100%'}
...
```{r prof2, fig.cap = "Screenshot of 'profvis::profvis()' output for the code creating the example at the start of this section, highlighting the time spent in 'engine\\$fontDef'.", echo = FALSE, eval = TRUE, out.width='100%'}
...
```{r prof3, fig.cap = "Screenshot of 'profvis::profvis()' output for the simple example in 'dvir' version 0.2-1, highlighting 'engine\\$fontDef'.", echo = FALSE, eval = TRUE, out.width='100%'}
...
```{r speedUp1Simple, fig.cap = "The average time spent in the \\texttt{grid.latex()} function, metric sweep and grid sweep before and after these changes, for each of the 20 runs of the simple example.", echo = FALSE, fig.width = 7, fig.height = 4}
...
```{r speedUp1Yee, fig.cap = "The average time spent in the \\texttt{grid.latex()} function, metric sweep and grid sweep before and after these changes, for each of the 20 runs of the complicated example.", echo = FALSE, fig.width = 7, fig.height = 4}
