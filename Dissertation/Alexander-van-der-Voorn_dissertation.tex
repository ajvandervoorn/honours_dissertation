...
\KeywordTok{grid.latex}\NormalTok{(}\StringTok{"$}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{dfrac\{}\CharTok{\textbackslash{}\textbackslash{}}\StringTok{mu^2\}\{2\}$"}\NormalTok{, }\DataTypeTok{x =} \FloatTok{0.03}\NormalTok{, }\DataTypeTok{preamble =}\NormalTok{ preamble)}
\end{Highlighting}
\end{Shaded}
...
\caption{Screenshot of \\texttt\{profvis::profvis()\} output for the simple example in 'dvir' version 0.2-1.}\label{fig:prof1}
\end{figure}
