...
A counter is defined, in order to give each gradient definition unqiue identifier:

```
\newcount\pgf@sys@dvir@objectcount
```

A "wrapper" macro of what to do when a gradient fill is requested. Within this, the definition of the fill is created and outpu to the DVI file, followed by 
